...
const TextInput = ({ btnShowHide, btnShowHideFun, id, label, placeholder, min, name, required = false, type = 'text', onChange, onKeyDown, onBlur, value, error, note, inputIcon, disabled, hidden, loginInput, max, maxLength, minLength, pattern, password, className, accept, inputRef}: TextInputProps): ReactElement => {
