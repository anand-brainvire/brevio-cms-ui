				...
				<form onSubmit={formik.handleSubmit}>
					<div className='card-body'>
						...
						<div className='card-grid-addedit-page'>
							...
							<div>
								<TextArea id='description' required onChange={formik.handleChange} value={formik.values.description} onBlur={OnBlurFaq} label={t('Description')} error={getErrorFaq('description')} placeholder={''} />
							</div>
